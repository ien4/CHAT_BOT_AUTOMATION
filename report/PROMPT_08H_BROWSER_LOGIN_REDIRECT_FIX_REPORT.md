...
- `docs/PROJECT_PROGRESS.md`: cập nhật tiến độ Prompt 08H.
- `docs/FEATURE_AUDIT_CHECKLIST.md`: cập nhật checklist auth/browser sau Prompt 08H.
- `docs/REFACTOR_PLAN.md`: cập nhật kế hoạch và bước tiếp theo.
- `report/PROMPT_08H_BROWSER_LOGIN_REDIRECT_FIX_REPORT.md`: báo cáo này.
