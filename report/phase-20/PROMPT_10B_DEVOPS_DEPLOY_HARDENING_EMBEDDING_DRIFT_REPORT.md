...
- `docs/policies/DEPLOYMENT_POLICY.md` + `docs/runbooks/PRODUCTION_ROLLOUT_CHECKLIST.md` mới.
...
- Chi tiết: `docs/policies/DEPLOYMENT_POLICY.md`, `docs/runbooks/PRODUCTION_ROLLOUT_CHECKLIST.md`.
