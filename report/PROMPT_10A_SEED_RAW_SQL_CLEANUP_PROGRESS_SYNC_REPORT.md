...
- `report/PROMPT_10A_SEED_RAW_SQL_CLEANUP_PROGRESS_SYNC_REPORT.md`
...
- `docs/FEATURE_AUDIT_CHECKLIST.md`: thêm block Prompt 10A; mark seed unsafe raw SQL **Closed**; giữ lịch sử cũ.
- `docs/REFACTOR_PLAN.md`: thêm section Prompt 10A; Next = Prompt 10B; giữ section 09C.
