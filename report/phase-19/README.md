# Phase 19 / Dashboard Reports

| Report | Vai trò |
|---|---|
| `report/phase-19/PROMPT_19A_DASHBOARD_ANALYTICS_FEATURE_SPLIT_REPORT.md` | Analytics feature split |
| `report/bugs/PROMPT_19A_FIX_RUNTIME_BUG_SWEEP_REPORT.md` | Runtime bug sweep sau analytics |
...
| `report/bugs/PROMPT_21X_GLOBAL_DASHBOARD_RUNTIME_AND_DOCS_REPORT.md` | Global dashboard runtime proof + docs hub |

Sau Prompt 21X/21Y, mọi dashboard split mới phải clean `.next`, start fresh dev server, full route smoke, static asset smoke và dev log scan.
