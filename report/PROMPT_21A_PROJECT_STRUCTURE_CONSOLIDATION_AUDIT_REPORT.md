...
(Chi tiết scope/allowed/forbidden/validation/smoke/rollback/risk: `docs/PROJECT_STRUCTURE_CONSOLIDATION_PLAN.md` mục 7–9.)

## 10. Files changed

- `docs/PROJECT_STRUCTURE_CONSOLIDATION_PLAN.md` (mới)
- `docs/PROJECT_PROGRESS.md`
- `docs/FEATURE_AUDIT_CHECKLIST.md`
- `docs/REFACTOR_PLAN.md`
- `report/PROMPT_21A_PROJECT_STRUCTURE_CONSOLIDATION_AUDIT_REPORT.md` (mới)
