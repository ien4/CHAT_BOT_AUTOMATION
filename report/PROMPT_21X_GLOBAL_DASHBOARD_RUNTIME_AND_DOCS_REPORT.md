...
- `Bug_21C-3.md`
- `report/PROMPT_21C_3_DASHBOARD_CAMPAIGNS_REPORT.md`
...
Tạo `docs/PROJECT_STATUS_MASTER.md` gồm:
...
Tạo `docs/DOCS_REPORT_ORGANIZATION_MAP.md` và các index:
...
- `report/phase-22/README.md`
- `report/bugs/README.md`
- `report/PROMPT_21X_GLOBAL_DASHBOARD_RUNTIME_AND_DOCS_REPORT.md`
