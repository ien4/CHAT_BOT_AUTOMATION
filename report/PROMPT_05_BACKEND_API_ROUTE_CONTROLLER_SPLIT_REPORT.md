...
- `docs/ENV_POLICY.md`
- `report/PROMPT_04A_PROJECT_PROGRESS_REWRITE_REPORT.md`
...
| `report/PROMPT_05_BACKEND_API_ROUTE_CONTROLLER_SPLIT_REPORT.md` | Report Prompt 05. |
...
| `docs/PROJECT_PROGRESS.md` | Cập nhật trạng thái Prompt 05 và next step Prompt 05B. |
| `docs/FEATURE_AUDIT_CHECKLIST.md` | Thêm Prompt 05 update. |
| `docs/REFACTOR_PLAN.md` | Ghi Prompt 05 phase 1 đã hoàn thành. |
