...
- `report/PROMPT_08B_BACKEND_CHATWOOT_RUNTIME_REMOVAL_REPORT.md`
...
| Docs current | `docs/ENV_POLICY.md`, `docs/ARCHITECTURE.md`, `docs/FEATURE_INVENTORY.md`, `MULTITENANT_PROGRESS.md` | Copy/flow legacy | Docs | Không | 08C/08D/10 | ENV_POLICY cập nhật; docs lớn/historical giữ backlog. |
