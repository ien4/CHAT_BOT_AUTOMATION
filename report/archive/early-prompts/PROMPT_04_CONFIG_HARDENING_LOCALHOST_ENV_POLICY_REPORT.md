...
- Cập nhật `docs/status/PROJECT_PROGRESS.md`, `docs/status/FEATURE_AUDIT_CHECKLIST.md`, `docs/architecture/ARCHITECTURE.md`, `docs/roadmap/REFACTOR_PLAN.md`.
...
| `docs/policies/ENV_POLICY.md` | Tạo chính sách env: secret/public env, local vs production, validation an toàn, checklist deploy. |
| `docs/status/PROJECT_PROGRESS.md` | Ghi trạng thái Prompt 04 và rủi ro còn lại. |
| `docs/status/FEATURE_AUDIT_CHECKLIST.md` | Ghi audit config/env sau Prompt 04. |
| `docs/architecture/ARCHITECTURE.md` | Ghi bổ sung helper config sau Prompt 04. |
| `docs/roadmap/REFACTOR_PLAN.md` | Đánh dấu Prompt 04 hoàn thành và định hướng Prompt 05. |
