...
| `docs/status/PROJECT_PROGRESS.md` | Cập nhật Prompt 06, validation history, risks, next step. |
| `docs/status/FEATURE_AUDIT_CHECKLIST.md` | Thêm bảng Prompt 06. |
| `docs/roadmap/REFACTOR_PLAN.md` | Thêm kế hoạch sau repository phase 1. |
| `docs/architecture/ARCHITECTURE.md` | Ghi rõ repository layer phase 1 và dependency rule sau Prompt 06. |
