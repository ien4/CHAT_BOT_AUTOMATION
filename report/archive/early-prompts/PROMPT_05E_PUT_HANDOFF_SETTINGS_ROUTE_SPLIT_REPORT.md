...
- `report/archive/early-prompts/PROMPT_05D_FIX_HANDOFF_SETTINGS_ACCESSOR_REPORT.md`
- `report/archive/early-prompts/PROMPT_05D_SETTINGS_ROUTE_SPLIT_RUNTIME_REPORT.md`
...
| `docs/status/PROJECT_PROGRESS.md` | Cập nhật trạng thái Prompt 05E, validation, risk, next step. |
| `docs/status/FEATURE_AUDIT_CHECKLIST.md` | Thêm bảng Prompt 05E. |
| `docs/roadmap/REFACTOR_PLAN.md` | Thêm kế hoạch/định hướng sau Prompt 05E. |
| `report/archive/early-prompts/PROMPT_05E_PUT_HANDOFF_SETTINGS_ROUTE_SPLIT_REPORT.md` | Report prompt này. |
