...
| File | Mục đích |
|---|---|
| `docs/status/PROJECT_PROGRESS.md` | Trạng thái dự án và kết quả Prompt 02B. |
| `docs/status/FEATURE_AUDIT_CHECKLIST.md` | Checklist tính năng/rủi ro hiện tại. |
| `report/archive/early-prompts/PROMPT_01_PROJECT_AUDIT_CLEAN_ARCHITECTURE_REPORT.md` | Bản đồ kiến trúc và rủi ro ban đầu. |
| `report/archive/early-prompts/PROMPT_02B_SAFETY_FOUNDATION_BASELINE_VALIDATION_REPORT.md` | Checkpoint, dependency, validation baseline. |
...
| Working tree trước refactor | Chỉ có `docs/status/PROJECT_PROGRESS.md`, `docs/status/FEATURE_AUDIT_CHECKLIST.md`, report Prompt 02B chưa commit. |
...
| `docs/status/PROJECT_PROGRESS.md` | Thêm Prompt 03 update. |
| `docs/status/FEATURE_AUDIT_CHECKLIST.md` | Thêm Prompt 03 static validation update. |
...
| File | Kết quả |
|---|---|
| `docs/architecture/ARCHITECTURE.md` | Tạo mới, mô tả hiện trạng, mục tiêu, dependency rule, layer mapping, vùng không move và validation guardrails. |
| `docs/roadmap/REFACTOR_PLAN.md` | Tạo mới, chia roadmap Prompt 04-10 với mục tiêu, file được phép/không được phép sửa, validation và rollback risk. |
| `docs/status/PROJECT_PROGRESS.md` | Cập nhật Prompt 03 status. |
| `docs/status/FEATURE_AUDIT_CHECKLIST.md` | Cập nhật static validation update cho Prompt 03. |
