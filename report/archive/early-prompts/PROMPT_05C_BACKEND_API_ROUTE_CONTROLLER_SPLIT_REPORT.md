...
- `report/archive/early-prompts/PROMPT_05B_BACKEND_API_ROUTE_CONTROLLER_SPLIT_REPORT.md`
...
| `report/archive/early-prompts/PROMPT_05C_BACKEND_API_ROUTE_CONTROLLER_SPLIT_REPORT.md` | Report Prompt 05C. |
...
| `docs/status/PROJECT_PROGRESS.md` | Cập nhật trạng thái Prompt 05C và next step Prompt 05R. |
| `docs/status/FEATURE_AUDIT_CHECKLIST.md` | Thêm checklist Prompt 05C. |
| `docs/roadmap/REFACTOR_PLAN.md` | Ghi Prompt 05C đã hoàn thành phase 3 và khuyến nghị Prompt 05R. |
