...
- `report/archive/early-prompts/PROMPT_05R_FEATURE_INVENTORY_LOCAL_RUN_RUNTIME_SMOKE_REPORT.md` — kết luận `BLOCKED — needs local/test env`.
- `docs/architecture/FEATURE_INVENTORY.md` — liệt kê 9 nhóm chức năng, không mục nào runtime PASS.
- `docs/runbooks/LOCAL_RUN_GUIDE.md` — có checklist chuẩn bị `backend/.env`, `dashboard/.env.local`, DB local/test.
- `docs/status/PROJECT_PROGRESS.md` — đã ghi Prompt 05R blocked, không đánh dấu runtime PASS.
- `docs/status/FEATURE_AUDIT_CHECKLIST.md` — runtime smoke 3 route = BLOCKED.
- `docs/roadmap/REFACTOR_PLAN.md` — ghi cần chạy lại Prompt 05R sau khi có env/DB.
...
| `git status` ban đầu | 3 modified (`docs/status/FEATURE_AUDIT_CHECKLIST.md`, `docs/status/PROJECT_PROGRESS.md`, `docs/roadmap/REFACTOR_PLAN.md`) + 3 untracked (`docs/architecture/FEATURE_INVENTORY.md`, `docs/runbooks/LOCAL_RUN_GUIDE.md`, `report/PROMPT_05R_*_REPORT`) |
...
- `docs/architecture/FEATURE_INVENTORY.md` — OK
- `docs/runbooks/LOCAL_RUN_GUIDE.md` — OK
- `report/archive/early-prompts/PROMPT_05R_FEATURE_INVENTORY_LOCAL_RUN_RUNTIME_SMOKE_REPORT.md` — OK
- `docs/status/PROJECT_PROGRESS.md` — OK
- `docs/status/FEATURE_AUDIT_CHECKLIST.md` — OK
- `docs/roadmap/REFACTOR_PLAN.md` — OK
...
Ghi chú: file `report/archive/early-prompts/PROMPT_05R_GIT_RECOVERY_REPORT.md` này được tạo sau commit trên nên hiện là untracked (không nằm trong commit `2bf4386`).
