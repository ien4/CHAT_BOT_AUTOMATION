...
- `report/PROMPT_21B_2_BACKEND_ROUTE_CONSOLIDATION_REPORT.md`
- `report/PROMPT_21B_BACKEND_ROUTE_CONSOLIDATION_REPORT.md`
...
| DevOps/deploy goal | Dùng `migrate deploy`, không `db push --accept-data-loss` | Policy/docs Done; production rollout chưa chạy | `docs/DEPLOYMENT_POLICY.md`, `docs/PRODUCTION_ROLLOUT_CHECKLIST.md` | Backup + migrate deploy + prod smoke thật |
