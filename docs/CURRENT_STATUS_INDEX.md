...
| 21D/21B-5 hoặc dashboard split kế tiếp | Sau 21C-3, chỉ tiếp tục backend route read-only nhỏ nếu audit đủ an toàn, hoặc dashboard page nhỏ khác với mutation/action bị khóa rõ. |
