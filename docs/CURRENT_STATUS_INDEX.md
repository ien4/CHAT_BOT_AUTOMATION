...
- Local runtime hiện là **PASS** sau Prompt 22A-2: Docker/DB/backend ready, migrate deploy no pending, local smoke an toàn PASS.
- Public HTTPS staging hiện là **PUBLIC_SMOKE_BLOCKED_STAGING_BASE_URL_MISSING** sau Prompt 22A-2: chưa có `STAGING_BASE_URL`, nên chưa claim public staging ready.
