...
Trạng thái mới nhất: **PASS**. Prompt 21Y đã move vật lý docs/report sang cấu trúc theo nhóm, tạo `docs/status/PROJECT_PROGRESS_MASTER.md`, cập nhật current index/status/map/README và chạy regression gate để chứng minh việc move docs không làm phát sinh bug dashboard/backend.

Đã làm:

- Move docs root sang `docs/status/`, `docs/index/`, `docs/roadmap/`, `docs/runbooks/`, `docs/policies/`, `docs/architecture/`, `docs/archive/`.
- Move reports root sang `report/phase-17/`, `report/phase-18/`, `report/phase-19/`, `report/phase-20/`, `report/phase-21/`, `report/phase-22/`, `report/bugs/`, `report/archive/early-prompts/`.
...
- Cập nhật `docs/index/CURRENT_STATUS_INDEX.md`, `docs/status/PROJECT_STATUS_MASTER.md`, `docs/index/DOCS_REPORT_ORGANIZATION_MAP.md` theo trạng thái 21Y.
- Không sửa backend/dashboard source, schema/migration/package/lock/env.

Validation bắt buộc: dashboard typecheck/build PASS, backend quality PASS, Prisma validate PASS, broken-link check trong `docs/` và `report/` PASS, full dashboard route smoke PASS, static asset smoke PASS, dev log scan sạch.

Chi tiết: `report/phase-21/PROMPT_21Y_DOCS_REPORT_REORGANIZATION_REPORT.md`.
...
Chi tiết: `report/bugs/PROMPT_21X_GLOBAL_DASHBOARD_RUNTIME_AND_DOCS_REPORT.md`.
...
Chi tiết: `report/phase-19/PROMPT_21C_3_DASHBOARD_CAMPAIGNS_REPORT.md`.
...
Chi tiết: `report/phase-19/PROMPT_21C_2_DASHBOARD_QUICK_REPLIES_REPORT.md`.
...
Chi tiết: `report/bugs/PROMPT_21C_FIX_DASHBOARD_RUNTIME_CHUNK_ERROR_REPORT.md`.
...
Chi tiết: `report/phase-19/PROMPT_21C_DASHBOARD_CONTENT_PACKAGES_REPORT.md`.
...
Chi tiết: `report/phase-21/PROMPT_21B_4_BACKEND_ROUTE_CONSOLIDATION_REPORT.md`.
...
Chi tiết: `report/phase-22/PROMPT_22C_META_REAL_EVENT_REPORT.md`.
...
Chi tiết: `report/phase-22/PROMPT_22B_META_VERIFY_CHALLENGE_REPORT.md`.
...
Chi tiết: `report/phase-22/PROMPT_22A_2_NGROK_PUBLIC_SMOKE_REPORT.md`.
...
- Tạo `docs/runbooks/META_WEBHOOK_STAGING_RUNBOOK.md`.
...
Chi tiết: `report/phase-22/PROMPT_22A_1_WEBHOOK_LOG_REDACTION_REPORT.md`.
...
- Tạo `docs/status/META_WEBHOOK_STAGING_READINESS.md` với kiến trúc đúng `https://<domain>/webhook`, checklist staging, public smoke plan và bước verify Meta thủ công.
...
Chi tiết: `report/phase-22/PROMPT_22A_META_WEBHOOK_STAGING_READINESS_REPORT.md`.
...
- Tạo `docs/index/CURRENT_STATUS_INDEX.md` làm điểm vào hiện tại cho trạng thái dự án, No-Chatwoot target, webhook, deployment, quality và next prompt.
- Tạo `docs/index/HISTORICAL_DOCS_INDEX.md` để phân loại report lịch sử, root docs stale và cách đọc tài liệu cũ.
...
Chi tiết: `report/phase-21/PROMPT_21D_DOCS_LEGACY_CLEANUP_REPORT.md`.
...
| Production rollout | **PRODUCTION_PENDING** | `docs/runbooks/PRODUCTION_ROLLOUT_CHECKLIST.md` yêu cầu backup + migrate deploy + smoke prod; chưa chạy | Không ghi production ready. |
...
Phase 21 vẫn **Started** (consolidation từng bước); **chưa Done**. Chi tiết: `report/phase-21/PROMPT_21B_2_BACKEND_ROUTE_CONSOLIDATION_REPORT.md`.
...
Phase 21 vẫn **Started — audit/plan-only chuyển sang consolidation từng bước**; **chưa Done**. Chi tiết: `report/phase-21/PROMPT_21B_BACKEND_ROUTE_CONSOLIDATION_REPORT.md`.
...
- Tạo mới `docs/roadmap/PROJECT_STRUCTURE_CONSOLIDATION_PLAN.md` (map backend/dashboard/docs + đề xuất Phase 21B/21C/21D).

Phase 21 chuyển từ **Planned** sang **Started — audit/plan-only** (chưa move code, chưa restructure thật, chưa Done). Production rollout thật **CHƯA chạy** — chỉ ghi nhận local/staging readiness improved. Chi tiết: `report/phase-21/PROMPT_21A_PROJECT_STRUCTURE_CONSOLIDATION_AUDIT_REPORT.md`.
...
| Phase 18b — Quality gate | ✅ Done | Prompt 10C: `npm run quality` backend (syntax+prisma validate) + dashboard (typecheck+build) PASS; ESLint chưa cài (lint để prompt dependency riêng); production smoke dry-run local 9/9. `docs/policies/QUALITY_GATE.md` |
...
- [x] Cập nhật `docs/policies/ENV_POLICY.md` sang No-Chatwoot target env policy.
- [x] Tạo `docs/roadmap/NO_CHATWOOT_SCHEMA_ENV_CLEANUP_PLAN.md`.
...
- [x] Tạo report Prompt 08C: `report/phase-17/PROMPT_08C_PRISMA_ENV_NO_CHATWOOT_CLEANUP_PLAN_REPORT.md`.
...
- [x] Tạo report Prompt 08B: `report/phase-17/PROMPT_08B_BACKEND_CHATWOOT_RUNTIME_REMOVAL_REPORT.md`.
...
- [x] Tạo context kiến trúc mới: `docs/architecture/NO_CHATWOOT_DIRECT_ARCHITECTURE_CONTEXT.md`.
- [x] Tạo report Prompt 08A: `report/phase-17/PROMPT_08A_NO_CHATWOOT_ARCHITECTURE_AUDIT_REPORT.md`.
...
- [x] Tạo report Prompt 07D: `report/phase-17/PROMPT_07D_LEGACY_GLOBAL_ROUTE_AUTH_CLASSIFICATION_REPORT.md`.
...
- [x] Tạo report Prompt 07C: `report/phase-17/PROMPT_07C_DETAIL_RESOURCE_TENANT_GUARD_REPORT.md`.
...
- [x] Tạo report Prompt 07B: `report/phase-17/PROMPT_07B_CONVERSATION_TENANT_GUARD_REPORT.md`.
...
- [x] Tạo report Prompt 07A: `report/phase-17/PROMPT_07A_TENANT_AUTHORIZATION_HARDENING_REPORT.md`.
...
- [x] Tạo report Prompt 07: `report/phase-17/PROMPT_07_TENANT_SAFETY_AUDIT_REPORT.md`.
...
- [x] Tạo report Prompt 01: `report/archive/early-prompts/PROMPT_01_PROJECT_AUDIT_CLEAN_ARCHITECTURE_REPORT.md`.
...
- [x] Tạo report blocked: `report/archive/early-prompts/PROMPT_02_BLOCKED_NEED_GIT_CHECKPOINT.md`.
- [x] Không sửa source runtime.
...
- [x] Tạo `docs/status/PROJECT_PROGRESS.md`.
- [x] Tạo `docs/status/FEATURE_AUDIT_CHECKLIST.md`.
- [x] Tạo report Prompt 02A: `report/archive/early-prompts/PROMPT_02A_PROJECT_PROGRESS_AND_AUDIT_PLAN_REPORT.md`.
...
- [x] Tạo `docs/architecture/ARCHITECTURE.md`.
- [x] Tạo `docs/roadmap/REFACTOR_PLAN.md`.
...
- [x] Tạo `docs/policies/ENV_POLICY.md`.
- [x] Cập nhật `backend/.env.example`.
- [x] Tạo `dashboard/.env.example`.
- [x] Cập nhật `docs/architecture/ARCHITECTURE.md`.
- [x] Cập nhật `docs/roadmap/REFACTOR_PLAN.md`.
- [x] Cập nhật `docs/status/FEATURE_AUDIT_CHECKLIST.md`.
- [x] Tạo report Prompt 04: `report/archive/early-prompts/PROMPT_04_CONFIG_HARDENING_LOCALHOST_ENV_POLICY_REPORT.md`.
...
- [x] Rewrite `docs/status/PROJECT_PROGRESS.md`.
- [x] Cập nhật `docs/status/FEATURE_AUDIT_CHECKLIST.md`.
- [x] Tạo report `report/archive/early-prompts/PROMPT_04A_PROJECT_PROGRESS_REWRITE_REPORT.md`.
...
- [x] Tạo `docs/architecture/FEATURE_INVENTORY.md` (9 nhóm chức năng, không đánh dấu runtime PASS).
- [x] Tạo `docs/runbooks/LOCAL_RUN_GUIDE.md` (trạng thái, cách chạy an toàn, checklist thủ công).
...
- [x] Tạo report `report/archive/early-prompts/PROMPT_05R_FEATURE_INVENTORY_LOCAL_RUN_RUNTIME_SMOKE_REPORT.md`.
...
- [x] Tạo report `report/archive/early-prompts/PROMPT_05R_ENV_RUNTIME_SMOKE_REPORT.md`.
...
- [x] Tạo report `report/archive/early-prompts/PROMPT_05R_LOCALDB_PGVECTOR_FIX_REPORT.md`.
...
- [x] Tạo report `report/archive/early-prompts/PROMPT_05D_SETTINGS_ROUTE_SPLIT_RUNTIME_REPORT.md`.
...
- [x] Tạo report `report/archive/early-prompts/PROMPT_05D_FIX_HANDOFF_SETTINGS_ACCESSOR_REPORT.md`.
...
- [x] Dừng backend process do prompt khởi động; giữ DB container/volume/env local.
- [x] Không sửa webhook handlers, tenant handoff, RAG, bot engine/tools, dashboard frontend, Prisma schema/migrations, package hoặc DevOps scripts.
- [x] Tạo report `report/archive/early-prompts/PROMPT_05E_PUT_HANDOFF_SETTINGS_ROUTE_SPLIT_REPORT.md`.
...
- [x] Dừng backend process do prompt khởi động; giữ DB container/volume/env local.
- [x] Không sửa webhook handlers, tenant handoff, RAG, bot engine/tools, dashboard frontend, Prisma schema/migrations, package hoặc DevOps scripts.
- [x] Tạo report `report/archive/early-prompts/PROMPT_06_REPOSITORY_LAYER_SETTINGS_PROMPTS_REPORT.md`.
...
- [x] Không sửa webhook handlers, tenant handoff, RAG, bot engine/tools, dashboard frontend, Prisma schema/migrations, package hoặc DevOps scripts.
- [x] Tạo report `report/archive/early-prompts/PROMPT_06B_TELEGRAM_DESTINATIONS_REPOSITORY_REPORT.md`.
...
- [x] Không sửa webhook handlers, tenant handoff, RAG, bot engine/tools, dashboard frontend, Prisma schema/migrations, package hoặc DevOps scripts.
- [x] Tạo report `report/archive/early-prompts/PROMPT_06C_PROMPTS_REPOSITORY_TENANT_SCOPE_REPORT.md`.
...
| Container start chạy `prisma migrate deploy` | Closed ở Prompt 10B | P0 | `backend/Dockerfile` CMD chỉ còn `node src/index.js`; migration tách thành release step riêng (docs/policies/DEPLOYMENT_POLICY.md) |
...
| Dashboard lint chưa cấu hình | Partial ở Prompt 10C | P1 | Có `npm run quality` (typecheck + build); `next lint` cần cài ESLint (interactive) → để prompt dependency riêng, xem docs/policies/QUALITY_GATE.md |
| npm audit vulnerabilities | Open | P1 | Prompt security deps riêng |
| Hard-code localhost trong script/root | Open | P1 | Prompt 10 |
| `webhook-urls-current.txt` có thể stale | Closed ở Prompt 10B | P1 | Thêm warning header local/stale + trỏ direct `/webhook` No-Chatwoot và docs/policies/DEPLOYMENT_POLICY.md |
...
Lưu ý tái chạy: Prompt 05R-LOCALDB-FIX đã dựng DB pgvector local **bền vững** (`bbotech-pgvector-local`, port 5433, volume `bbotech_pgvector_local_data`) và giữ `backend/.env`. User chạy lại backend bằng: `docker start bbotech-pgvector-local` → `cd backend` → `npm run dev` (xem `docs/runbooks/LOCAL_RUN_GUIDE.md` mục 1c). Không chạy migration/db push/Docker compose/start-all trên dữ liệu production.
